#!/usr/bin/env python3
"""EVERFRESH — 7-day snapshot. Pulls the 'log' sheet as public CSV, prints a
...
print(f"=== EVERFRESH 7-day snapshot ===")
...
fig.autofmt_xdate()
ax.set_title(f"EVERFRESH — last 7 days  (as of {anchor:%-m/%d %-I:%M%p})  fw {last['fw']}")
l1,lb1=ax.get_legend_handles_labels(); l2,lb2=ax2.get_legend_handles_labels()
ax.legend(l1+l2,lb1+lb2,loc="upper left",fontsize=8,ncol=3)
fig.tight_layout()
out=os.path.join(os.environ.get("CODE_ATTACH_OUTBOX","."),"everfresh_week.png")
